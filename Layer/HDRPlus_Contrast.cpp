...
void CHDRPlus_Contrast::Forward(cv::Mat& pRGBImage, TGlobalControl* pControl)
{
	...
	float scale = 0.8f + 0.3f / MIN2(1.f, ContrastStrength);
...
#pragma omp parallel for 
	...
	{
		unsigned short* pRawline = (unsigned short*)(pRGBImage.data + y * pRGBImage.step[0]);
